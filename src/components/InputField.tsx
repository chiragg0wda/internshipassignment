...
// NOTE: Keeping props minimal for now — can extend later if needed
...
const InputField: React.FC<InputFieldProps> = ({
  ...
  // sizes map — could expand later if design system grows
  const sizeClasses = {
  ...
  // TODO: Maybe refactor variants to a utility function
  ...
  return (
    <div className="w-full">
      ...
      <div className="relative flex items-center">
        ...
        {/* Loading spinner */}
        {loading && <Loader2 className="absolute right-2 animate-spin text-gray-400" size={18} />}
      </div>
